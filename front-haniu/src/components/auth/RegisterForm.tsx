...
export default function RegisterForm() {
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    if (!isEmailOrPhoneValid) {
      setErrorMsg('Vui lòng nhập Email hoặc Số điện thoại hợp lệ.');
      return;
    }
    ...
    try {
      ...
      // We will trigger verification step
  ...
  const handleVerifySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulating API call to register/verify OTP
      const payload = {
        fullName,
        email: isEmailValid(emailOrPhone) ? emailOrPhone : undefined,
        phone: isPhoneValid(emailOrPhone) ? emailOrPhone : undefined,
        password
      };
