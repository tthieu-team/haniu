      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-slate-400 dark:text-zinc-400 font-medium">
            ...
            <span className="text-rose-500 font-semibold">{ugc.hashtag}</span> để có cơ hội nhận voucher 100k
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {ugc.items.map((item) => (
            <a
              ...
              className="group relative aspect-square overflow-hidden rounded-2xl bg-zinc-900 border border-slate-100 dark:border-zinc-850 shadow-sm block"
            >
              {/* Image */}
              <img
                src={item.imageUrl}
              ...
              <div className="absolute inset-0 bg-rose-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-white space-y-2">
                {/* Instagram Icon SVG */}
                <svg
