      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-slate-800 dark:text-zinc-100 sm:text-5xl leading-tight">
            ...
            <div className="grid grid-cols-2 gap-6">
              {brandIntro.stats.map((stat, idx) => (
                ...
                >
                  ...
                  <span className="block mt-2 text-xs font-bold tracking-wider uppercase text-slate-500 dark:text-zinc-400">
                    {stat.label}
                  </span>
                </div>
              ))}
