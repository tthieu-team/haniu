...
export default function StickyBuyBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-t border-slate-200/60 dark:border-zinc-800/80 shadow-2xl pt-2.5 pb-[calc(10px+env(safe-area-inset-bottom))] px-3 sm:px-4 transition-all duration-300 animate-slide-up">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex gap-1.5 sm:gap-2 shrink-0">
          <button
            onClick={onAddToCart}
            className="px-2.5 py-2 sm:px-4 sm:py-2.5 bg-slate-900 hover:bg-slate-850 dark:bg-zinc-100 dark:hover:bg-zinc-200 dark:text-zinc-950 text-white text-[9px] sm:text-[11px] font-bold rounded-xl transition-all shadow active:scale-95 whitespace-nowrap"
          >
            Thêm giỏ hàng
          </button>
          <button
